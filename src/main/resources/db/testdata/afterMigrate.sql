...
values (1,"52036b40-bf3a-4197-9398-2130f8f25e43", 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil', 'CRIADO', utc_timestamp, 298.90, 10, 308.90);
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
            endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, "0f85253d-a4a5-43bf-83ac-29d4047c8d07", 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro', 'CRIADO', utc_timestamp, 79, 0, 79);
