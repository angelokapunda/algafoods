...
alter table restaurante_id add constraint FKlpawy170hsi5alvcvwuchhiiy foreign key (restaurante_id) references restaurante (id);
alter table restaurante_id add constraint FK15e8ge1mi8yd9y6vtlieuqf23 foreign key (id) references produto (id);
